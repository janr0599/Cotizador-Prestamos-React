...
function App() {
  ...
  return (
    <div className=" my-2 max-w-lg mx-auto bg-white shadow p-10 ">
      ...
      <select
        className='mt-5 w-full p-2 bg-white border border-gray-300 rounded-lg text-center text-xl font-bold cursor-pointer text-gray-500'
        value={meses}
      ...
      <div className="my-5 space-y-3 bg-gray-100 p-5">
        ...
        <p className="text-xl text-gray-500 text-center font-bold"> Pagos mensuales: {formatearDinero(pagoMensual)}</p>
      </div>
